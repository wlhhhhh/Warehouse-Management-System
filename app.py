...
class EditFormOrders(FlaskForm):
    ...
    orderstatus = Select('订单状态', validators=[],
                         ...
                         choices={("已送达", "已送达"), ("运输中", '运输中'), ("未送出", "未送出")}, default='', coerce=str)
...
class EditFormLineitem(FlaskForm):
    ...
    returnflag = Select('是否退货', validators=[], render_kw={'class':'form-control'}, choices={('是', '是'), ('否', '否')}, coerce=str)
    ...
    receiptdate = DateField('收获日期', default='', validators=[], render_kw={'id':'date2'}, format='%Y-%m-%d')
...
def UpdateFormLineitem():
    ...
    EditFormLineitem.returnflag = Select('是否退货', validators=[], render_kw={'class':'form-control'}, choices={('是', '是'), ('否', '否')}, coerce=str)
    EditFormLineitem.linestatus = Select('订单明细状态', validators=[],
                                        render_kw={'class':'form-control'},
                                        choices={("已送达", "已送达"), ("运输中", '运输中'), ("未送出", "未送出")}, default=0, coerce=str)
